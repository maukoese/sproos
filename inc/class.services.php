...
class _hServices {
  ...
  function createService() {
    ...
    $h_link = hADMIN."service?view=".$h_code;
  ...
  <i class="material-icons">create</i></a>
      ...
      while ( $servicesDetails = mysqli_fetch_assoc( $getServicesBy)){
        ...
        <td class="mdl-data-table__cell--non-numeric">
          <?php _show_( $servicesDetails['h_organization'] ); ?>
        </td>
        <td class="mdl-data-table__cell--non-numeric">
          <?php _show_( ucwords( $servicesDetails['h_location'] ) ); ?>
        </td>
        <td class="mdl-data-table__cell--non-numeric">
        <a href="./service?view=<?php _show_( $servicesDetails['h_code'] ); ?>&key=<?php _show_( $servicesDetails['h_alias'] ); ?>" ><i class="material-icons">perm_identity</i></a> 
  ...
  function getServiceCode( $code) {
    ...
    if ( $getServiceCode -> num_rows > 0) {
      while ( $serviceDetails = mysqli_fetch_assoc( $getServiceCode)){
        ...
        ?><title><?php _show_( $serviceDetails['h_alias'] ); ?> [ <?php showOption( 'name' ); ?> ]</title>
        <div class="mdl-grid" >
                    ...
                    <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor(); ?>">
                        ...
                        <div class="mdl-card__supporting-text mdl-card--expand mdl-grid">
                          <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                            ...
                            <b>Center:</b> <a href="./resource?center=<?php _show_( $serviceDetails['h_organization'] ); ?>"><?php _show_( $serviceDetails['h_organization'] ); ?></a><br>
                ...
                <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--4-col-tablet mdl-cell--12-col-phone">
                    <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor(); ?>">
                        ...
                        <i class="material-icons">local_hospital</i>
                          <span class="mdl-button"><?php _show_( $serviceDetails['h_organization'] ); ?></span>
                            <div class="mdl-layout-spacer"></div>
