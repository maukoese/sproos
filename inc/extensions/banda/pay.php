...
?>
<title>Pay [ <?php showOption( 'name' ); ?> ]</title>
  <div class="mdl-grid mdl-card">
	...
	<div id="shopping-cart" class="mdl-cell mdl-cell--12-col grid mdl-color--<?php primaryColor(); ?>" >
	...
	<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp mdl-color--<?php primaryColor(); ?>">
	<tbody>
	<tr>
	<th class="mdl-data-table__cell--non-numeric">ITEM</th>
	<th class="mdl-data-table__cell--non-numeric">QTY</th>
